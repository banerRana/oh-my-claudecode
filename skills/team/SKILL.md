...
Spawn N coordinated agents working on a shared task list using Claude Code's native team tools. Built-in team management, inter-agent messaging, and task dependencies -- no external dependencies required.
